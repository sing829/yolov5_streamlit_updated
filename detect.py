    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if len(det):
                ...
                # Regex to store food name only
                s = s.upper()
                words_pattern = '[a-z]+'
                food = re.findall(words_pattern, s, flags=re.IGNORECASE)
                ...
                food_set = food[1:]
                food_list = []
                # Code to show calories
                    # print(st.write(name))

                for name in food_set: 
                    if name == 'AVOCADO' or name == 'AVOCADOS':
                        food_list.append(name)
                        # print(st.write(f'Avocado: {avo_option} calories per 100g'))
                    elif name == 'BROCCOLI' or name == 'BROCCOLIS':
                        food_list.append(name)
                        # print(st.write(f'Broccoli: {broc_option} calories per 100g'))   
                    elif name == 'CHICKEN'or name == 'CHICKENS':
                        food_list.append(name)
                        # print(st.write(f'Chicken: {chic_option} calories per 100g'))
                    elif name == 'EGG' or name == 'EGGS':
                        food_list.append(name)
                        # print(st.write(f'Egg: {egg_option} calories per 100g'))
                    elif name == 'RICE':
                        food_list.append(name)
                        # print(st.write(f'Rice: {rice_option} calories per 100g'))
                    elif name == 'SHRIMP' or name == 'SHRIMPS':
                        food_list.append(name)
                        # print(st.write(f'Shrimp: {shr_option} calories per 100g'))
                    elif name == 'STEAK' or name == 'STEAKS':
                        food_list.append(name)
                        # print(st.write(f'Steak: {steak_option} calories per 100g'))
                    elif name == 'TOMATO' or name == 'TOMATOS':
                        food_list.append(name)
                        # print(st.write(f'Tomato: {tmt_option} calories per 100g'))
                    elif name == 'YOGURT' or name == 'YOGURTS':
                        food_list.append(name)
                        # print(st.write(f'Yogurt: {yo_option} calories per 100g'))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save-txt', default='True', action='store_true',
                        help='save results to label.txt')
